      ...
      <div class="col-md-8">
        	...
        	<ul class="nav nav-tabs tintuc" role="tablist"  style="height:34px;">
                <li role="presentation" class="active" style="height:34px;">
                    <a href="#home_news_tab_1" role="tab" data-toggle="tab" style="height:34px; font-size:16px;font-family:Arial; line-height:0.5">KẾT QUẢ TÌM ĐƯỢC</a>
                </li>
               
            </ul>
        </div>
        <div class="container-fluid">
        <h3><b>Tổng cộng : Có tất cả <?php echo "$soluong"; ?> kết quả được tìm thấy. </b></h3>
        	<table>
					  <?php
			            foreach ($results as $value) {
            			    echo '<tr >';
                			echo '<td  style="padding-bottom:20px;"><a href="http://thethaodt.vn/tin-tuc/'. $value['id'] . '/'. $value['url'] . '">['. $value['type'] . ']['. $value['type_dr'] . ']'. $value['title'] . '</td>';
