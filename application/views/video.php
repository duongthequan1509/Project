...
<html lang="en">
  <head>
    <title>Video-Thể Thao Điện Tử</title>
        ...
        <div class="container-fluid">
            <div class="row">
              <?php
                     ...
                     echo    '<ul>';
                     echo    '<li><a href="http://thethaodt.vn/tin-tuc/'. $value['id'] . '/'. $value['url'] . '"> <img src="../../public/upload/user/'. $value['img'] . '"></a></li>';
                     echo    '<li><a href="http://thethaodt.vn/tin-tuc/'. $value['id'] . '/'. $value['url'] . '"><p><b><h4>['. $value['type_dr'] . ']'. $value['title'] . '</h4></b></a>'. $value['sumay'] .'</p></li>';
                     echo    '</ul>';
					 echo 	 '</div>';
                     }
              ?>
