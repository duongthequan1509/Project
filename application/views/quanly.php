                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Danh Mục <small> Thể loại</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                              <a href="http://thethaodt.vn/ttdt/insert"  <i class="fa fa-dashboard"></i>Thêm</a>
                            </li>
                        </ol>
                    </div>
                </div>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php print_r($soluongtt) ?></div>
                                        <div>Tin Tức!</div>
                                    </div>
                                </div>
                            </div>
                            <a href="http://thethaodt.vn/ttdt/quanly_tt">
                        ...
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php print_r($soluongsk) ?></div>
                                        <div>Sự Kiện!</div>
                                    </div>
                                </div>
                            </div>
                            <a href="http://thethaodt.vn/ttdt/quanly_sk">
                                <div class="panel-footer">
                                    <span class="pull-left">Chi Tiết</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                        ...
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php print_r($soluongsp) ?></div>
                                        <div>Sản Phẩm!</div>
                                    </div>
                                </div>
                            </div>
                            <a href="http://thethaodt.vn/ttdt/quanly_sp">
                                <div class="panel-footer">
                                    <span class="pull-left">Chi Tiết</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                        ...
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php print_r($soluongvd) ?></div>
                                        <div>ViDeo!</div>
                                    </div>
                                </div>
                            </div>
                            <a href="http://thethaodt.vn/ttdt/quanly_vd">
                                <div class="panel-footer">
                                    <span class="pull-left">Chi Tiết</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
