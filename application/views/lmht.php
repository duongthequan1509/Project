...
<html lang="en">
  <head>
    <title>Tin tức-Thể Thao Điện Tử</title>
    		 ...
    		 <div class="col-md-8">
                            <div class="navbar-collapse collapse" >
                              <ul class="nav  navbar-nav focus">
                                ...
                                <li><a href="video" style="padding-right:30px;color:#545454"">VIDEO</a></li>
                                <li class="dropdown">
      ...
      <div class="col-md-8">
       <?php
      	...
      	echo '<div class="container-fluid tag_follow" style="padding-top:0px;">';
                ...
                echo '<li><a href="http://thethaodt.vn/tin-tuc/'. $value['id'] . '/'. $value['url'] . '"><p><b><h4>['. $value['type_dr'] . ']'. $value['title'] . '</h4></b>
                            </p></a>
                    <p>'. $value['sumay'] .'</p></li>';  
            	echo '</ul>';
        ...
        <div class="container-fluid">
            <div class="row">
              <?php
                     foreach ($tinlmht as $value) {
				     echo    '<div class="col-md-4 md_4"  >';
                     echo    '<ul>';
                     echo    '<li><a href="http://thethaodt.vn/tin-tuc/'. $value['id'] . '/'. $value['url'] . '"> <img src="../../public/upload/user/'. $value['img'] . '"></a></li>';
                     echo    '<li><a href="http://thethaodt.vn/tin-tuc/'. $value['id'] . '/'. $value['url'] . '"><p><b>['. $value['type_dr'] . ']'. $value['title'] . '</b></p></a><p style="font-size:12px; color: #000;">'. $value['sumay'] .'</p></li>';
                     echo    '</ul>';
					 echo 	 '</div>';
                     }
              ?>
        ...
        <div class="container-fluid" style="padding-top:20px;">
        	<ul > <?php
			 foreach ($tinlmhtthem as $value) {
            echo	  '<li> <hr></li>';
            echo     '<li><a href="http://thethaodt.vn/tin-tuc/'. $value['id'] . '/'. $value['url'] . '"> <p style="color: #999">['. $value['type_dr'] . ']'. $value['title'] . '</p></a></li>';
			 }
			  ?> 
            </ul>
        </div>
